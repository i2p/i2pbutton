...
const kMODULE_CONTRACTID = "@geti2p.net/cookie-jar-selector;1";
const kMODULE_CID = Components.ID("e6204253-b690-4159-bfe8-d4eedab6b3be");

const Cr = Components.results;
const Cu = Components.utils;

Cu.import("resource://i2pbutton/modules/default-prefs.js", {})
  .ensureDefaultPrefs();
...
function CookieJarSelector() {
  ...
  this.logger = Components.classes["@geti2p.net/i2pbutton-logger;1"]
  ...
  observe : function(aSubject, aTopic, aData) {
       switch(aTopic) {
        case "cookie-changed":
            ...
            if (aData == "added"
                && prefs.getBoolPref("extensions.i2pbutton.cookie_auto_protect")
                && !prefs.getBoolPref("extensions.i2pbutton.tor_memory_jar"))
            {
